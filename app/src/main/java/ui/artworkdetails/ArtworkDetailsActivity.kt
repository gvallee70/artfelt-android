...
import ui.home.artworks.artwork.ArtworkAdapter
import ui.home.artworks.artwork.ArtworkDelegate
...
import ui.artworkdetails.artist.ArtistView
...
class ArtworkDetailsActivity: AppCompatActivity(), HeaderDelegate, ArtworkDelegate {
    ...
    companion object {
        const val ARTWORK = "ui/artworkdetails"
    }
    ...
    private fun getArtistArtworksAPICall() {
        GlobalScope.launch(Dispatchers.Main) {
            try {
                val getArtworksResponse = ArtfeltClient().getApiService(this@ArtworkDetailsActivity).getArtistInfo(artwork.artist?.id!!)
